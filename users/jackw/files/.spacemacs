...
before packages are loaded."
  ...
  ;; Tell lsp-mode that the "pyright" dependency is satisfied by basedpyright-langserver
  (lsp-dependency
   'pyright
   '(:system "basedpyright-langserver")
   '(:npm :package "basedpyright" :path "basedpyright"))

  ;; Use the correct binary for the language server
  (setq-default lsp-pyright-langserver-command "basedpyright")

  ;; Make sure it's applied buffer-locally for all Python buffers
  (defun my/use-basedpyright ()
    (setq-local lsp-pyright-langserver-command "basedpyright"))
  (add-hook 'python-mode-hook #'my/use-basedpyright)
  )
  ...
  (custom-set-variables
   ...
   '(package-selected-packages
     '(ace-link aggressive-indent all-the-icons auto-compile auto-highlight-symbol
                ...
                column-enforce-mode company-box company-quickhelp cython-mode
                ...
                flyspell-correct-helm frame-local gh-md git-link git-messenger
                ...
                hungry-delete hybrid-mode indent-guide info+ inspector js2-mode
                ...
                python-pytest quickrun rainbow-delimiters restart-emacs shell-pop
                simple-httpd smeargle space-doc spaceline spacemacs-purpose-popwin
                ...
                tern toc-org treemacs-evil treemacs-icons-dired treemacs-magit
                treemacs-persp treemacs-projectile undo-fu-session unfill
                vi-tilde-fringe volatile-highlights vundo web-beautify wgrep winum
                writeroom-mode ws-butler yapfify yasnippet-snippets)))
  (custom-set-faces
